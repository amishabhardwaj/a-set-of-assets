...
%>
  ...
  <a class="active" href="ViewReport.jsp"><b>View Reports</b></a>
  <a href="logout" class="logoutbtn"><b>Logout<b></a> 
	...
	<div class="split right">
		<br> <br> <br> <br> <br>
		<h1 align="center">Graph of Quantity vs. Item</h1>
...
<button onclick="picture()" id="bttn" style="display:block; margin: 0 auto;">Click here to view number of assets which have been bought....</button>
