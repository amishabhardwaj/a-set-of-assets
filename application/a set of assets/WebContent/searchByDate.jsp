...
%>
  ...
  <a href="logout" class="logoutbtn"><b>Logout<b></a> 
	...
	<div class="split right">
		<br> <br> <br> <br> <br>
		<h1 align="center">Please search by date!</h1>

		<form method="post" action="bydate" align="center">
...
//		System.out.println("from jsp " + list1);
		...
		<table border=5 align="center">
			<c:forEach items="${list1}" var="obj1">
				...
				<tr>
					<td>Return Date</td>
					<th>${obj1.returnDate }</th>
				</tr>
				<tr>
					<td>Ban Start Date</td>
					<th>${obj1.banStartDate }</th>
				</tr>
			</c:forEach>
		</table>
